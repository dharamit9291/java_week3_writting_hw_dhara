...
public class Programme15_Wall {
    ...
    public static void main(String[] args) {
        Programme15_Wall programme15_wall = new Programme15_Wall(5,4);
        System.out.println(" area= " + programme15_wall.getArea());
        programme15_wall.setHeight(-1.5);
        System.out.println(" width= " + programme15_wall.getWidth());
        System.out.println(" height= " + programme15_wall.getHeight());
        System.out.println(" area= " + programme15_wall.getArea());
    }
}
